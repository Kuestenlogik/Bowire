 ...
 * launch-stepper cards. The source PNGs live one directory up from the
 * Bowire repo (in C:\Projekte\Kuestenlogik\*.png) and weigh ~2 MB each
 * — too heavy to ship verbatim onto the marketing landing page.
 *
...
// Sources sit one directory above the Bowire repo
// (C:\Projekte\Kuestenlogik\). path.resolve treats 'C:' as a relative
// component and would land in CWD; using the explicit path string +
// resolving once gives the correct absolute Windows path.
