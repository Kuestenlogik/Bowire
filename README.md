...
- [Bootcamp](https://bowire.io/bootcamp/) — 9-lesson hands-on walkthrough from first call to authoring your own protocol plugin, ~3 h, capstone included ([source on GitHub](https://github.com/Kuestenlogik/Bowire.Bootcamp))
