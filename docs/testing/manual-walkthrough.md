...
- [ ] Left rail shows the always-on set: **Home** (active by default), Discover, Workspaces. Disabled / optional rails (Recordings, Mocks, Flows, Proxy, Benchmarks, Security) MAY also appear unchecked-but-visible.
