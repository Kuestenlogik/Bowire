...
A docker-compose Pulsar broker + .NET producer that publishes one message per second to a demo topic lives at [`samples/Pulsar`](https://github.com/Kuestenlogik/Bowire/tree/main/samples/Pulsar).
