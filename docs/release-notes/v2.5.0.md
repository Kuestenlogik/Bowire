---
title: The CI pillar — design-time lint, latency gates, a contract matrix, one rollup, and the workbench in your editor
version: 2.5.0
---
...
k6-style thresholds: `p95 < 200ms` is either met or the run exits non-zero.

```bash
bowire bench run --threshold "p95<200ms" --threshold "errors<1%"
```
