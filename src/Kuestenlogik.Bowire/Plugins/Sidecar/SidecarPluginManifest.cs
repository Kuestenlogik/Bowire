    ...
    [property: JsonPropertyName("version")] string? Version = null)
{
    ...
    /// <summary>True when the manifest has the minimum fields to load: a protocol id + an executable path.</summary>
    public bool IsValid =>
        !string.IsNullOrEmpty(Protocol?.Id) && !string.IsNullOrEmpty(Executable);
