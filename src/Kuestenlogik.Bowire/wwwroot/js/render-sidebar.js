    ...
    // in Phase 3).
    // #306/#314 — renderRecordingsSidebar moved into the Recordings
            ...
            onClick: function () {
                ...
                bowirePrompt('New name', {
                    ...
                    if (renamed && typeof renameWorkspace === 'function') {
                        ...
                        if (renameWorkspace(wsId, renamed)) {
    ...
    function renderSidebar() {
        ...
        switch (spec.kind) {
            ...
            // recordings: #306/#314 — renderer-key seam
            // (sidebarRendererKey=recordingsSidebar), handled before this switch.
